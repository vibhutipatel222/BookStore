...
<html>
<head>
<title>Online Book Shop | Other</title>
<!-- for-mobile-apps -->
							  ...
							  <div class="panel panel-default">
								<div class="panel-heading" role="tab" id="headingOne">
								  <h4 class="panel-title asd">
									<a class="pa_italic" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
									  <span class="glyphicon glyphicon-plus" aria-hidden="true"></span><i class="glyphicon glyphicon-minus" aria-hidden="true"></i>Other Exams
									</a>
								  </h4>
								</div>
								<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
								  <div class="panel-body panel_text">
									<ul>
										<li><a href="Other.php">Railway and GSRTC(ST)</a></li>
										<li><a href="Other2.php">Nurse and Police</a></li>
										<li><a href="Other3.php">Department Of Post And Talati</a></li>
										<li><a href="Other4.php">Others</a></li>
									</ul>
								  </div>
								</div>
							  </div>
					...
					<div class="w3ls_dresses_grid_right_grid3">
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
							<div class="agile_ecommerce_tab_left dresses_grid">
								...
								<div class="simpleCart_shelfItem">
									...
									<p><a class="item_add" href="cart.php?data=bk0020">Add to cart</a></p>
								</div>
							</div>
						</div>
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
							<div class="agile_ecommerce_tab_left dresses_grid">
								...
								<h5>TET</h5>
								<div class="simpleCart_shelfItem">
									<p><i class="item_price">₹800</i></p>
									<p><a class="item_add" href="cart.php?data=bk0024">Add to cart</a></p>
								</div>
							</div>
						</div>
						<div class="clearfix"> </div>
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
							<div class="agile_ecommerce_tab_left dresses_grid">
								...
								<div class="simpleCart_shelfItem">
									...
									<p><a class="item_add" href="cart.php?data=bk0040">Add to cart</a></p>
								</div>
							</div>
						</div>
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
							<div class="agile_ecommerce_tab_left dresses_grid">
								...
								<h5>Vanrakshak</h5>
								<div class="simpleCart_shelfItem">
									<p><i class="item_price">₹230</i></p>
									<p><a class="item_add" href="cart.php?data=bk0021">Add to cart</a></p>
								</div>
							</div>
						</div>
						<div class="clearfix"> </div>
